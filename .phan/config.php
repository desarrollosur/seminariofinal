...
return [
    ...
    'directory_list' => [
        '.',
        'vendor/2amigos/yii2-usuario/./src/User',
        'vendor/bedezign/yii2-audit/src',
        'vendor/codeception/base/ext',
        'vendor/codeception/specify/src',
        'vendor/elisdn/yii2-gii-fixture-generator/src',
        'vendor/elisdn/yii2-gii-fixture-generator/tests',
        'vendor/phan/phan/src/Phan',
        'vendor/phpdocumentor/reflection-docblock/src',
        'vendor/schmunk42/yii2-giiant/src',
        'vendor/yiisoft/yii2',
        'vendor/yiisoft/yii2-bootstrap/src',
        'vendor/yiisoft/yii2-debug/src',
